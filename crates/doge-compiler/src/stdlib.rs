...
impl ModuleFn {
    /// The largest argument count this member accepts.
    pub fn max_arity(&self) -> usize {
        self.arity + self.optional as usize
    }
}
    ...
    Module {
        ...
        funcs: &[
            ...
            ModuleFn {
                ...
                arity: 2,
                optional: true,
                runtime_fn: "howl_request",
                hint: "howl.request(method, url) or howl.request(method, url, opts)",
            },
        ],
        consts: &[],
    },
